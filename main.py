    ...
    for private_key in private_keys:
        ...
        while not success:
            try:
                ...
                vote_power_url = f"https://api.reya.xyz/api/vote/rnip1/user/{wallet_address}"
                ...
                contract_details_url = "https://api.reya.xyz/api/vote/contract-details/rnip1"
                ...
                vote_url = "https://api.reya.xyz/api/vote/0x876b9c2e6ae2caf0cda35a29117f0c62d3ed0776/vote"
                vote_payload = {
